...
export class AdminServiceService {
  ...
  updateStudent(id:string,studentData:User){
  ...
  updateTutor(id:string,tutorData:User){
  ...
  updateCourse(id:string,courseData:User){
    return this.http.post<ApiResponse>(`${apiUrls.adminApi}updateCourse/${id}`,{courseData},{withCredentials:true});
  }
